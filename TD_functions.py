...
Play_image = pg.transform.scale(pg.image.load(os.path.join('Images','Play Square Button.png')),(BS,BS))
...
def draw_window(time,E_list,Select,T_list,t_ind,animations,check_rad,Tower_locs,Money_text,Lives_text,Wave):
    ...
    if not(Wave):
        screen.blit(Play_image,[WIDTH-BS*2,HEIGHT-BS*3])
    pg.display.update()
